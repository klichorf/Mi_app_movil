...
class SuperHeroAdapter(private val superherolist:List<SuperHero>):RecyclerView.Adapter<SuperHeroViewHolder>(){ //Implementr metodos
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SuperHeroViewHolder {
  /// 7. pinta los items o pinta el layout...creamos el proyecyo O EL LAYAOU QUE SE INSERTARA EN CADA CASILLA
        val layoutInflater=LayoutInflater.from(parent.context)  // en este caso el contexto proviene de una vista "parent" que es del view group
        return SuperHeroViewHolder(layoutInflater.inflate(R.layout.item_superhero,parent,false))//retorna el layout que creamos
    }
    ...
    override fun getItemCount(): Int { //...6.)  provee el numero de items al recicler
      return  superherolist.size // me devuelve el tamaño de la lista
    }
    /*
